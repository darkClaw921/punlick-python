...
logger.add("chat_service.log", encoding="utf-8", rotation="10MB", 
           compression="zip",
...
class ChatService:
    ...
    async def process_chat_message(self, message_text: str, message_id: str) -> DocumentResponse:
        ...
        try:
            ...
            logger.error(f"Ошибка при обработке текстового сообщения {message_id}: {str(e)}")
            raise
